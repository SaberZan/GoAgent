...
[GoAgent v0.4.0](https://github.com/wimi321/GoAgent/releases/tag/v0.4.0)

| 平台 | 下载 |
| --- | --- |
| macOS Apple Silicon | [GoAgent-0.4.0-mac-arm64.dmg](https://github.com/wimi321/GoAgent/releases/download/v0.4.0/GoAgent-0.4.0-mac-arm64.dmg) |
| macOS Intel | [GoAgent-0.4.0-mac-x64.dmg](https://github.com/wimi321/GoAgent/releases/download/v0.4.0/GoAgent-0.4.0-mac-x64.dmg) |
| Windows x64 免安装 ZIP | [GoAgent-0.4.0-win-x64-portable.zip](https://github.com/wimi321/GoAgent/releases/download/v0.4.0/GoAgent-0.4.0-win-x64-portable.zip) |
| Windows x64 安装版 | [GoAgent-0.4.0-win-x64.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.0/GoAgent-0.4.0-win-x64.exe) |
| Windows NVIDIA 安装版 | [GoAgent-0.4.0-win-x64-nvidia.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.0/GoAgent-0.4.0-win-x64-nvidia.exe) |
