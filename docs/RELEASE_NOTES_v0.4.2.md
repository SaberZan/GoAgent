...
> `GoAgent-0.4.2-win-x64-nvidia-portable.zip` may exceed GitHub's 2 GB single-asset upload limit. If it is not attached, use the standard Windows package or build the NVIDIA portable package locally with `pnpm dist:local:win`.
...
| Windows NVIDIA 专版 | `GoAgent-0.4.2-win-x64-nvidia.exe` 或 `GoAgent-0.4.2-win-x64-nvidia-portable.zip` |
| 校验文件 | `SHA256SUMS.txt` |
...
| Windows NVIDIA 專版 | `GoAgent-0.4.2-win-x64-nvidia.exe` 或 `GoAgent-0.4.2-win-x64-nvidia-portable.zip` |
| 校驗檔 | `SHA256SUMS.txt` |
...
| Windows NVIDIA edition | `GoAgent-0.4.2-win-x64-nvidia.exe` or `GoAgent-0.4.2-win-x64-nvidia-portable.zip` |
...
| Windows NVIDIA 版 | `GoAgent-0.4.2-win-x64-nvidia.exe` または `GoAgent-0.4.2-win-x64-nvidia-portable.zip` |
...
| Windows NVIDIA 에디션 | `GoAgent-0.4.2-win-x64-nvidia.exe` 또는 `GoAgent-0.4.2-win-x64-nvidia-portable.zip` |
| 체크섬 | `SHA256SUMS.txt` |
...
| Windows รุ่น NVIDIA | `GoAgent-0.4.2-win-x64-nvidia.exe` หรือ `GoAgent-0.4.2-win-x64-nvidia-portable.zip` |
| Checksums | `SHA256SUMS.txt` |
...
| Windows phiên bản NVIDIA | `GoAgent-0.4.2-win-x64-nvidia.exe` hoặc `GoAgent-0.4.2-win-x64-nvidia-portable.zip` |
| Checksums | `SHA256SUMS.txt` |
