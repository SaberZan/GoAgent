...
test('renderer supports Alt-drag range selection and bounded summary payload', () => {
  ...
  assert.match(app, /runTeacherTaskWithStream\(\{[\s\S]*mode: 'move-range'/)
  assert.match(app, /moveRange: \{ start: rangeStart, end: rangeEnd \}/)
  assert.match(app, /onTeacherBoardImageRequest/)
